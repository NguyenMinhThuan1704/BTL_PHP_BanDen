            ...
            <div class="col-10 col-s-12 content">
                <div class="col-12 col-s-12 content">
                    <div class="tabcontent">
                        ...
                        <div class="row">
                            <form action="{{route('admin.tk-post-edit')}}" method="POST">
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    <select name="MaLoaiTK" id="TenloaiTK">
                                        ...
                                        @foreach ($cats as $cat)
                                            <option value="{{$cat->MaLoaiTK}}" {{ (old('MaLoaiTK') ?? $tkDetail->MaLoaiTK) == $cat->MaLoaiTK ? 'selected' : '' }}>{{$cat->TenLoaiTK}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    ...
                                    value="{{old('TenTaiKhoan') ?? $tkDetail->TenTaiKhoan}}">
                                    @error('TenTaiKhoan')
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    ...
                                    value="{{old('Email') ?? $tkDetail->Email}}">
                                    @error('Email')
                                        <span style="color: red;">{{$message}}</span>
                                    @enderror
                                </div>
