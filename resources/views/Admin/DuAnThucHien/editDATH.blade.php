            ...
            <div class="col-10 col-s-12 content">
                <div class="col-12 col-s-12 content">
                    <div class="tabcontent">
                        ...
                        <div class="row">
                            <form action="{{route('admin.dath-post-edit')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    ...
                                    value="{{old('TieuDe') ?? $dathDetail->TieuDe}}">
                                    @error('TieuDe')
                                ...
                                @if (!empty($dathDetail->AnhDaiDien))
                                    <div class="col-12 col-s-12 padding-box">
                                        <label>Ảnh đại diện:</label>
                                    </div>
                                    <div class="col-12 col-s-12 padding-box">
                                        <img id="previewImage" src="{{ !empty($dathDetail->AnhDaiDien) ? asset($dathDetail->AnhDaiDien) : '#' }}" alt="Ảnh đại diện" style="max-width: 200px;">
                                    </div>
                                @endif
                                <div class="col-12 col-s-12 padding-box">
