                    ...
                    <div class="tabcontent">
                        ...
                        <!-- <div class="row">
                            <div class="col-5 col-s-12 padding-box">
                                <input type="text" id="search-supplier" ng-model="tenncc" placeholder="Nhập tên nhà cung cấp...">
                            </div>
                            <div class="col-5 col-s-12 padding-box">
                                <input type="text" id="search-address" ng-model="diachincc" placeholder="Nhập địa chỉ nhà cung cấp...">
                            </div>
                        ...
                        <div class="row" style="display: inherit;">
                            <form action="{{ route('admin.ncc-search') }}" method="POST">
                                @csrf
                                <div class="col-5 col-s-12 padding-box">
                                    <input value="{{$TenNhaPhanPhoi}}" type="text" name="TenNhaPhanPhoi" placeholder="Nhập tên nhà cung cấp...">
                                </div>
                                <div class="col-5 col-s-12 padding-box">
                                    <input value="{{$DiaChi}}" type="text" name="DiaChi" placeholder="Nhập địa chỉ nhà cung cấp...">
                                </div>
                                <div class="col-2 col-s-12 padding-box">
                        ...
                        <a href="{{route('admin.ncc-create')}}" class="">
                            <button class="btn-form submit" style="background-color: rgba(44, 140, 15, 0.8); margin-left: 8px">Thêm nhà cung cấp</button>
                        </a>
                        <div class="row">
                                    ...
                                    <tbody> 
                                        @if (!empty($supplierList))
                                            @foreach ($supplierList as $item)
                                                <tr style="text-align: center;">
                                                    <td style="text-align: center;">{{$item->MaNhaPhanPhoi}}</td>
                                                    ...
                                                    <td>
                                                        <a href="{{route('admin.ncc-edit', ['MaNhaPhanPhoi'=>$item->MaNhaPhanPhoi])}}">
                                                            <i class="fas fa-edit" title="Sửa"></i>
                                                        </a>
                                                        <a onclick="return confirm('Bạn có chắc muốn xóa không?')" href="{{route('admin.ncc-delete', ['MaNhaPhanPhoi'=>$item->MaNhaPhanPhoi])}}">
                                        ...
                                        @else
                                            <tr>
                                                <td clospan = "6">Không có nhà cung cấp</td>
                                            </tr>
                                        @endif
