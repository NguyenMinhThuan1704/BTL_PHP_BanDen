            ...
            <div class="col-10 col-s-12 content">
                <div class="col-12 col-s-12 content">
                    <div class="tabcontent">
                        ...
                        <div class="row">
                            <form action="{{route('admin.sp-post-edit')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    <select name="MaLoaiSanPham" id="TenLoaiSanPham">
                                        ...
                                        @foreach ($cats as $cat)
                                            <option value="{{$cat->MaLoaiSanPham}}" {{ (old('MaLoaiSanPham') ?? $spDetail->MaLoaiSanPham) == $cat->MaLoaiSanPham ? 'selected' : '' }}>{{$cat->TenLoaiSanPham}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12 col-s-12 padding-box">
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    ...
                                    value="{{old('TenSanPham') ?? $spDetail->TenSanPham}}">
                                    @error('TenSanPham')
                                ...
                                @if (!empty($spDetail->AnhDaiDien))
                                    <div class="col-12 col-s-12 padding-box">
                                        <label>Ảnh đại diện:</label>
                                    </div>
                                    <div class="col-12 col-s-12 padding-box">
                                        <img id="previewImage" src="{{ !empty($spDetail->AnhDaiDien) ? asset($spDetail->AnhDaiDien) : '#' }}" alt="Ảnh đại diện" style="max-width: 200px;">
                                    </div>
                                @endif
                                <div class="col-12 col-s-12 padding-box">
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    ...
                                    value="{{old('GiaGiam') ?? $spDetail->GiaGiam}}">
                                    @error('GiaGiam')
                                        <span style="color: red;">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    ...
                                    value="{{old('SoLuong') ?? $spDetail->SoLuong}}">
                                    @error('SoLuong')
                                        <span style="color: red;">{{$message}}</span>
                                    @enderror
                                </div>
