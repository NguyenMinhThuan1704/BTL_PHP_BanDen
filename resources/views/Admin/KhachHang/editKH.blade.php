            ...
            <div class="col-10 col-s-12 content">
                <div class="col-12 col-s-12 content">
                    <div class="tabcontent">
                        ...
                        <div class="row">
                            <form action="{{route('admin.kh-post-edit')}}" method="POST">
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    <select name="id" id="TenTaiKhoan">
                                        ...
                                        @foreach ($cats_tk as $cat)
                                            <option value="{{$cat->id}}" {{ (old('id') ?? $khDetail->id) == $cat->id ? 'selected' : '' }}>{{$cat->id}} - {{$cat->TenTaiKhoan}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12 col-s-12 padding-box">
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    ...
                                    value="{{old('TenKH') ?? $khDetail->TenKH}}">
                                    @error('TenKH')
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    ...
                                    value="{{old('DiaChi') ?? $khDetail->DiaChi}}">
                                    @error('DiaChi')
                                        <span style="color: red;">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-s-12 padding-box">
                                    ...
                                    value="{{old('Email') ?? $khDetail->Email}}">
                                    @error('Email')
                                        <span style="color: red;">{{$message}}</span>
                                    @enderror
                                </div>
