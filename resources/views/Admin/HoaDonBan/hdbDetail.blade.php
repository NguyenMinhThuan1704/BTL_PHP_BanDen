            ...
            <div class="col-10 col-s-12 content">
                <div class="col-12 col-s-12 content">
                    <div class="tabcontent">
                        <div class="title">
                            <i class="fas fas fa-boxes"></i> {{$title}} {{$hoadon->MaHoaDon}}
                            <hr>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-s-12 padding-box hdb_title" style="font-size: 1.8rem; text-align: center;">Thông tin khách hàng</div>
                            <div class="col-12 col-s-12 padding-box hdb_title">
                                <label for="txtright">Tên khách hàng:</label>
                            </div>
                            <div class="col-12 col-s-12 padding-box hdb_title">
                                <input type="text" id="TenKH" name="TenKH" disabled placeholder="Nhập tên khách hàng..."
                                value="{{$hoadon->TenKH}}">
                            </div>
                            <div class="col-12 col-s-12 padding-box hdb_title">
                            ...
                            <div class="col-12 col-s-12 padding-box hdb_title">
                                <input type="text" id="DiaChi" name="DiaChi" disabled placeholder="Nhập địa chỉ khách hàng..."
                                value="{{$hoadon->DiaChi}}">
                            </div>
                            ...
                            <div class="col-12 col-s-12 padding-box hdb_title">
                                <input type="tel" id="SDT" name="SDT" disabled placeholder="Nhập số điện thoại khách hàng..."
                                value="{{$hoadon->SDT}}">
                            </div>
                            <div class="col-12 col-s-12 padding-box hdb_title">
                            ...
                            <div class="col-12 col-s-12 padding-box hdb_title">
                                <input type="email" id="Email" name="Email" disabled placeholder="Nhập email khách hàng..."
                                value="{{$hoadon->Email}}">
                            </div>
                        </div>

                        <div class="row">
                            <a href="{{ route('admin.hdb-index')}}" class="btn btn-primary col-12 col-s-12 padding-box" style="margin: 30px 0" style="color: white; padding: 6px 14px;">Quay lại</a>
                        </div>
                    </div>
                </div>
            </div>
