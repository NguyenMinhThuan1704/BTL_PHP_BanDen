...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/khuyenmai.css') }}">
            ...
            <div class="grid wide">
                <nav class="header__nav nav_pc">
                    ...
                    <ul class="header__nav-list">
                        ...
                        <li class="header__nav-item">
                            <a style="color: #ffbe00" href="{{route('user.khuyenmai')}}">Khuyến mãi</a>
                        </li>
                        <li class="header__nav-item">
        ...
        <div class="container grid wide">
            <div class="new_title">
                <ul class="breadcrumb title-h2">
                    ...
                    <li class="breadcrumb-item"><h2>Khuyến mãi</h2></li>
                </ul>
            </div>
            ...
            <div class="content row">
                <div class="col c-12">
                    <article class="content_text">
                        <h2 style="text-align: center;"><span style="font-size:26px;"><span style="color:#ff0000;"><span><var><strong>ĐÈN TRANG TRÍ KHUYẾN MÃI</strong></var></span></span></span></h2>
                        ...
                        <p><span style="font-size:24px;"><span><span style="color:#0000cd;">Xem chi tiết tại đây:</span> <a href="https://thegioianhsang.vn/den-khuyen-mai" style="color: #44b362;">https://thegioianhsang.vn/den-khuyen-mai</a></span></span></p>
                    </article>
                </div>
            </div>
        </div>
