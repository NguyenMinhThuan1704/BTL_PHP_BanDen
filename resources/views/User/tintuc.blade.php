...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/tintuc.css') }}">
            ...
            <div class="grid wide">
                <nav class="header__nav nav_pc">
                    ...
                    <ul class="header__nav-list">
                        ...
                        <li class="header__nav-item">
                            <a style="color: #ffbe00" href="{{route('user.tintuc')}}">Tin tức</a>
                        </li>
                        <li class="header__nav-item">
            ...
            <div class="new__product">
                <div class="row new__product-item-wrapper">
                  @foreach ($TinTuc as $item)
                    <div class="new__product-item col l-4 c-6">
                        <div class="new__product-img-wrapper">
                            <a href="./chitiettintuc" style="width: 100%;">
                                <img src="{{ asset($item->AnhDaiDien)}}" alt="" class="new__product-img">
                            </a>
                        </div>

                        <h4 class="title-h4">
                            <a href="./chitiettintuc" title="{{$item->TieuDe}}">{{$item->TieuDe}}</a>
                        </h4>
                ...
                <div class="footer__wrapper">
                    ...
                    <div class="footer-right col l-6">
                        ...
                        <div class="footer-img">
                            <img src="{{ asset('/assets/img/footer/img.png') }}" alt="">
                            <img src="{{ asset('/assets/img/footer/img2.png') }}" alt="">
                        </div>
