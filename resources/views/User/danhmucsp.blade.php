        ...
        <div class="container grid wide">
            <div class="new_title">
                <ul class="breadcrumb title-h2">
                  ...
                  <li class="breadcrumb-item">
                            <a href="" title="Đèn chùm">Danh mục / {{ $categoryName }}</a>
                  </li>
                </ul>
            </div>
                            ...
                            <div class="new__product-item col l-3 c-6">
                                ...
                                <div class="product__title">
                                    <div class="product__title-name">
                                        <a href="{{route('user.getDetailProduct', ['MaSanPham'=>$item->MaSanPham, 'MaLoaiSanPham' => $item->MaLoaiSanPham])}}">{{$item->TenSanPham}}</a>
                                    </div>
