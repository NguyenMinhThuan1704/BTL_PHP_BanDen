            ...
            <div class="grid wide">
                <nav class="header__nav nav_pc">
                    ...
                    <ul class="header__nav-list">
                        ...
                        <li class="header__nav-item">
                            <a style="color: #ffbe00" href="{{route('user.duanthuchien')}}">Dự án thực hiện</a>
                        </li>
                        <li class="header__nav-item">
                            <a href="">Catalogue</a>
                        </li>
        ...
        <div class="container grid wide">
            <div class="new_title">
                <ul class="breadcrumb title-h2">
                  ...
                  <li class="breadcrumb-item">
                    <a href="" title="Dự án thực hiện">Dự án thực hiện</a>
                  </li>
                </ul>
            </div>
                ...
                <div class="row new__product-item-wrapper">
                  @foreach ($DuAnThucHien as $item)
                    <div class="new__product-item col l-4 c-6">
                        ...
                        <h4 class="title-h4">
                            <a href="#" title="{{$item->TieuDe}}">{{$item->TieuDe}}</a>
                        </h4>
